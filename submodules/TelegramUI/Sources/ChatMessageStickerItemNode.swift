...
class ChatMessageStickerItemNode: ChatMessageItemView {
    ...
    override func animateCustomInsertion() {
        ...
        if let stickerNode = AnimationManager.shared.stickerNode {
            animateSticker()
        } else {
            animateEmoji()
        }
    ...
    private func animateSticker() {
        ...
        AnimationManager.shared.animate(dateAndStatusNode, fromAlpha: 0, toAlpha: 1, curve: settings.curveScale)
    }
    ...
    private func animateEmoji() {
        ...
        var emojiSize = inputFrame.size
        let aspect = imageNode.frame.width / imageNode.frame.height
        emojiSize.width = emojiSize.height * aspect
        ...
        AnimationManager.shared.animate(imageNode, from: frame, curveX: settings.curveX, curveY: settings.curveY, curveScale: settings.curveBubble)
        AnimationManager.shared.animate(dateAndStatusNode, fromAlpha: 0, toAlpha: 1, curve: settings.curveStatus)
    }
